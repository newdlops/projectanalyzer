...
export function getFunctionTutorGuideStyles(): string {
  return /* css */ `
    .logic-function-guide { display: grid; gap: 8px; padding: 10px; border-top: 1px solid var(--vscode-panel-border); min-width: 0; }
    .logic-function-guide-content { display: grid; gap: 10px; min-width: 0; }
    .logic-guide-kicker { color: var(--vscode-descriptionForeground); font-size: var(--logic-font-small); font-weight: 700; letter-spacing: .04em; }
    .logic-guide-title, .logic-function-guide h3 { margin: 0; color: var(--vscode-foreground); font-size: var(--logic-font-medium); line-height: 1.3; }
    .logic-guide-intro, .logic-guide-status, .logic-guide-answer, .logic-guide-empty, .logic-guide-scenario-body > p, .logic-guide-scenario-description { margin: 0; color: var(--vscode-descriptionForeground); font-size: var(--logic-font-small); line-height: 1.45; overflow-wrap: anywhere; }
    ...
    .logic-guide-facts li { display: grid; gap: 2px; min-width: 0; padding: 6px 0; border-bottom: 1px solid var(--vscode-panel-border); font-size: var(--logic-font-small); overflow-wrap: anywhere; }
    ...
    .logic-guide-source-basis, .logic-guide-scenarios, .logic-guide-limits { color: var(--vscode-descriptionForeground); font-size: var(--logic-font-small); line-height: 1.45; }
    .logic-guide-source-basis summary, .logic-guide-scenarios summary, .logic-guide-limits summary { color: var(--vscode-foreground); cursor: pointer; }
    .logic-guide-source-basis summary:focus-visible, .logic-guide-scenarios summary:focus-visible, .logic-guide-limits summary:focus-visible { outline: 1px solid var(--vscode-focusBorder); outline-offset: 2px; }
    .logic-guide-source-basis ul, .logic-guide-limits ul { display: grid; gap: 4px; margin: 6px 0 0; padding-left: 18px; }
    ...
    @media (max-width: 520px) { .logic-guide-overview dl { grid-template-columns: 1fr; gap: 1px; } .logic-guide-overview dd { margin-bottom: 5px; } .logic-guide-scenario-table th:nth-child(4), .logic-guide-scenario-table td:nth-child(4), .logic-guide-transition-table th:nth-child(4), .logic-guide-transition-table td:nth-child(4) { display: none; } }
