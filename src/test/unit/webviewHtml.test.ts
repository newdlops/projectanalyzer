...
test("sidebar HTML renders file navigation as an import tree", () => {
  ...
  assert.match(scriptMatch[1], /createFunctionFlowTreeRows/);
  assert.match(scriptMatch[1], /createFunctionUniverse/);
  assert.match(scriptMatch[1], /createAllFunctionsInventoryRows/);
  assert.match(scriptMatch[1], /createFunctionFlowRowsWithInventory/);
  ...
  assert.match(scriptMatch[1], /Entrypoints/);
  assert.match(scriptMatch[1], /All Functions/);
